...
class PublicOrganizationTransformationBlock(BaseModel):
    ...
    show_in_ai_actions: StrictBool = Field(..., alias="showInAIActions", description="Whether to show this block in 'AI Actions'. Only applies for standalone blocks.")
    __properties = ["id", "ownerOrganizationId", "ownerOrganizationName", "name", "created", "lastUpdated", "description", "operatesOn", "allowExtraCliArguments", "parameters", "parametersUI", "repositoryUrl", "showInDataSources", "showInCreateTransformationJob", "showInSyntheticData", "showInAIActions"]
