...
class SampleProposedChanges(BaseModel):
    ...
    bounding_boxes: Optional[List[BoundingBox]] = Field(None, alias="boundingBoxes")
    metadata: Optional[Dict[str, StrictStr]] = Field(None, description="Sample free form associated metadata. You'll need to update the complete metadata object here.")
