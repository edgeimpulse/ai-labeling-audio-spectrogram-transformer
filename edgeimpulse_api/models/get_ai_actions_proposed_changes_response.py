...
class GetAIActionsProposedChangesResponse(BaseModel):
    ...
    __properties = ["success", "error", "proposedChanges"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAIActionsProposedChangesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAIActionsProposedChangesResponse:
        """Create an instance of GetAIActionsProposedChangesResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetAIActionsProposedChangesResponse.construct(**obj)

        _obj = GetAIActionsProposedChangesResponse.construct(**{
