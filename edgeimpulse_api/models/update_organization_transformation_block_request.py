...
class UpdateOrganizationTransformationBlockRequest(BaseModel):
    ...
    operates_on: Optional[TransformationJobOperatesOnEnum] = Field(None, alias="operatesOn")
    ...
    show_in_data_sources: Optional[StrictBool] = Field(None, alias="showInDataSources", description="Whether to show this block in 'Data sources'. Only applies for standalone blocks.")
    ...
    show_in_ai_actions: Optional[StrictBool] = Field(None, alias="showInAIActions", description="Whether to show this block in 'AI Actions'. Only applies for standalone blocks.")
