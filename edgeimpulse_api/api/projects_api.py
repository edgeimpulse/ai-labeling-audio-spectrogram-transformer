...
from edgeimpulse_api.models.get_ai_actions_config_response import GetAIActionsConfigResponse
...
class ProjectsApi(object):
    ...
    @validate_arguments
    def add_project_api_key(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], add_project_api_key_request : AddProjectApiKeyRequest, **kwargs) -> GenericApiResponse:  # noqa: E501
        """Add API key
    ...
    @validate_arguments
    def get_ai_actions_config(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs) -> GetAIActionsConfigResponse:  # noqa: E501
        """Get AI Actions config

        Get the last used AI Actions config
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetAIActionsConfigResponse
        """
        kwargs['_return_http_data_only'] = True
        return self._get_ai_actions_config_with_http_info(project_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _get_ai_actions_config_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs):  # noqa: E501
        """Get AI Actions config 
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetAIActionsConfigResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_ai_actions_config" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetAIActionsConfigResponse",
        }
