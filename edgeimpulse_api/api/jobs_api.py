...
from edgeimpulse_api.models.create_ai_actions_job_request import CreateAIActionsJobRequest
...
class JobsApi(object):
    ...
    @validate_arguments
    def create_ai_actions_job(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], create_ai_actions_job_request : CreateAIActionsJobRequest, **kwargs) -> StartJobResponse:  # noqa: E501
        """Create AI Actions job

        Run an AI Actions job over a subset of data. This will instruct the block to apply the changes directly to your dataset. To preview, use \"createPreviewAIActionsJob\".

        :param project_id: Project ID (required)
        :type project_id: int
        :param create_ai_actions_job_request: (required)
        :type create_ai_actions_job_request: CreateAIActionsJobRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._create_ai_actions_job_with_http_info(project_id, create_ai_actions_job_request, **kwargs)  # noqa: E501

    @validate_arguments
    def _create_ai_actions_job_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], create_ai_actions_job_request : CreateAIActionsJobRequest, **kwargs):  # noqa: E501
        """Create AI Actions job 
        ...
        # process the body parameter
        _body_params = None
        if _params['create_ai_actions_job_request']:
            _body_params = _params['create_ai_actions_job_request']
        ...
        return self.api_client.call_api(
            '/api/{projectId}/jobs/ai-actions', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def create_preview_ai_actions_job(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], create_preview_ai_actions_job_request : CreatePreviewAIActionsJobRequest, **kwargs) -> StartJobResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._create_preview_ai_actions_job_with_http_info(project_id, create_preview_ai_actions_job_request, **kwargs)  # noqa: E501

    @validate_arguments
    def _create_preview_ai_actions_job_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], create_preview_ai_actions_job_request : CreatePreviewAIActionsJobRequest, **kwargs):  # noqa: E501
        """Create preview AI Actions job 
        ...
        return self.api_client.call_api(
            '/api/{projectId}/jobs/ai-actions-preview', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
