...
from edgeimpulse_api.models.get_ai_actions_preview_request import GetAIActionsPreviewRequest
...
class RawDataApi(object):
    ...
    @validate_arguments
    def get_auto_labeler_segment_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], sample_id : Annotated[StrictInt, Field(..., description="Sample ID")], **kwargs) -> GetAutoLabelerSegmentInfoResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetAutoLabelerSegmentInfoResponse
        """
        kwargs['_return_http_data_only'] = True
        return self._get_auto_labeler_segment_info_with_http_info(project_id, sample_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _get_auto_labeler_segment_info_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], sample_id : Annotated[StrictInt, Field(..., description="Sample ID")], **kwargs):  # noqa: E501
        """View auto-labeler segment info 
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetAutoLabelerSegmentInfoResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_auto_labeler_segment_info" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetAutoLabelerSegmentInfoResponse",
        }

        return self.api_client.call_api(
            '/api/{projectId}/raw-data/auto-labeler/samples/{sampleId}/segments', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def get_sample(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], sample_id : Annotated[StrictInt, Field(..., description="Sample ID")], limit_payload_values : Annotated[Optional[StrictInt], Field(description="Limit the number of payload values in the response")] = None, cache_key : Annotated[Optional[StrictStr], Field(description="If set, then a long cache header is sent. If this is omitted then a no-cache header is sent. You can use this if you f.e. know the last modified date of a sample. Stick the last modified date in the cache key, so the sample can be stored in browser cache (and will automatically be invalidated if the modified date changes).")] = None, impulse_id : Annotated[Optional[StrictInt], Field(description="Impulse ID. If this is unset then the default impulse is used.")] = None, **kwargs) -> GetSampleResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._get_sample_with_http_info(project_id, sample_id, limit_payload_values, cache_key, impulse_id, **kwargs)  # noqa: E501
    ...
    @validate_arguments
    def preview_ai_actions_samples(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], get_ai_actions_preview_request : GetAIActionsPreviewRequest, **kwargs) -> ListSamplesResponse:  # noqa: E501
        """Preview samples for AI Actions

        Get a number of random samples to show in the AI Actions screen

        :param project_id: Project ID (required)
        :type project_id: int
        :param get_ai_actions_preview_request: (required)
        :type get_ai_actions_preview_request: GetAIActionsPreviewRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._preview_ai_actions_samples_with_http_info(project_id, get_ai_actions_preview_request, **kwargs)  # noqa: E501

    @validate_arguments
    def _preview_ai_actions_samples_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], get_ai_actions_preview_request : GetAIActionsPreviewRequest, **kwargs):  # noqa: E501
        """Preview samples for AI Actions 
        ...
        _all_params = [
            'project_id',
            'get_ai_actions_preview_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        # process the body parameter
        _body_params = None
        if _params['get_ai_actions_preview_request']:
            _body_params = _params['get_ai_actions_preview_request']
        ...
        return self.api_client.call_api(
            '/api/{projectId}/raw-data/ai-actions-preview', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
