...
#     type=str,
#     required=True,
#     help='Comma separated list of labels from "AudioSet" that will be be used to label the sample. When model returns any other label, the label for this sample in Edge Impulse will be set to "noise"',
# )
...
#     type=str,
#     required=False,
#     help="Which category to upload data to in Edge Impulse",
#     default="split",
# )
# parser.add_argument(
...
#     type=bool,
#     required=False,
#     help="Skip uploading to EI",
#     default=False,
# )

# args, unknown = parser.parse_known_args()

# # Set up ingestion URL
...
def create_splits_and_classify_from_wav(
    ...
    If the multilabel_output is enabled, return a structured multilable list and files list
    """
...
for sample in samples:
    ...
    intervals_list, files_list = create_splits_and_classify_from_wav(
        sample_file_path, OUTPUT_PATH, 5000, 2000, HF_API_KEY
    )
